...
$RunbookName = "Get-AzureADUser"

try
{
    # Test data
    #$UserPrincipalName = "PJETEST1012@ecco.com"
    ...
    $rbLog.WriteLogEntry($RunbookName,"User found in Azure AD $($user.UserPrincipalName)")
