...
$RunbookName = "Connect-ExchangeOnPrem"
...
try
{
    ...
    $uri = Get-AutomationVariable -Name "ConnectionURI-ExchangeOnPremises"
    $session= New-PSSession -Name $RunbookName -ConfigurationName Microsoft.Exchange -ConnectionUri $uri -Authentication Kerberos
